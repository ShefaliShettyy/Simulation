...
class UtilizationCostModel:
    ...
    def compute_all(self, all_stats: List[AgentUtilizationStats]) -> Tuple[float, float, Dict]:
...
class BurnoutCostModel:
    ...
    def compute_all(self, all_stats: List[AgentUtilizationStats]) -> Tuple[float, Dict]:
        total = 0.0
        per_agent: Dict[str, Dict[str, float]] = {}
        for st in all_stats:
    ...
    def collect(self) -> List[AgentUtilizationStats]:
        ...
        for agent in agents:
            ...
            result.append(AgentUtilizationStats(
                ...
                shift_minutes   =getattr(cfg, "measurement_minutes", cfg.sim_duration_minutes),
...
class CostLedger:
    ...
    def record_utilization_costs(self, per_agent: Dict, agent_skill_map: Dict[str, str],
    ...
    def record_burnout_costs(self, per_agent: Dict, agent_skill_map: Dict[str, str],
...
class SystemCostFunction:
    def __init__(self, staffing_model: StaffingCostModel, ledger: CostLedger,
...
class CostAwareEngine(SimulationEngine):
    def __init__(self, config: SimulationConfig, cost_cfg: Optional[CostConfig] = None,
